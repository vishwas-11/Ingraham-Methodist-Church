    ...
    <>
      ...
      <section className="relative w-full h-[614px] min-h-[400px] flex items-center justify-center -mt-[72px]">
        <div className="absolute inset-0 z-0 bg-[#4A0F1A]">
          ...
          ></div>
          <div className="absolute inset-0 bg-[rgba(25,8,8,0.45)] pointer-events-none"></div>
          {/* Bottom Fade Gradient restricted to bottom 96px (h-24) so it stays completely below hero subtitle text */}
        ...
        <div className="relative z-10 text-center px-margin-mobile md:px-margin-desktop max-w-[800px] mx-auto mt-16 pb-6">
          <div className="flex flex-col items-center mb-6 w-full">
            <span className="text-[#CDAA63] font-label-md tracking-[0.2em] uppercase text-[12px] md:text-[13px] mb-3" style={{ textShadow: '0 2px 14px rgba(0,0,0,0.7)' }}>Fellowship & Gathering</span>
            <div className="h-px w-32 bg-[rgba(205,170,99,0.35)]"></div>
          </div>
          <h1 className="font-display-lg text-[48px] md:text-[72px] leading-[1.05] text-[#F4E7D3] mb-6 animate-fade-in-up" style={{ textShadow: '0 2px 16px rgba(0,0,0,0.8)' }}>
      ...
      {/* Unified Main Page Body with Single Parchment Background & Texture throughout */}
        ...
        <div className="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop animate-fade-in-up">
          ...
          {upcomingEvents.length > 0 && (
            <div className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-[1240px] mx-auto">
          ...
          <div className="w-full flex items-center justify-center mb-20 py-2">
